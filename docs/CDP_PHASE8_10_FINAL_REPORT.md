...
The Phase 8.9 baseline and hashes are frozen under `evaluation_results/phase8_10/baseline/`. The locked holdout was not accessed. Extraction parity passes; the later architecture reset found that historical end-to-end decision parity fails because policy and route modes differ. Secondary provenance coverage is 100%, unknown dependency is 0%, and no new model, router, or decision-policy tuning was introduced.
