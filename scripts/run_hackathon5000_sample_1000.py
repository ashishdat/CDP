#!/usr/bin/env python3
"""Hackathon-5000 stratified 1000 — FAST (latency) or PRODUCT (STP gate).
...
Usage:
  python3 -u scripts/run_hackathon5000_sample_1000.py           # FAST latency
  python3 -u scripts/run_hackathon5000_sample_1000.py --product # STP gate run
  python3 -u scripts/run_hackathon5000_sample_1000.py --fresh
"""
...
DOCS = ROOT / "docs/metrics/hackathon5000_sample_1000_v1/selected_documents.txt"
OUT = ROOT / "evaluation_results/hackathon5000_sample_1000_v1"
...
def main() -> int:
    ...
    # Point meters at this run's out-dir so cost accounting is isolated.
    ...
    write_run_manifest(
        ...
        extra={
            "runner": "run_hackathon5000_sample_1000",
            "docs": len(docs),
            "selection_seed": 20260925,
            "alloc": {"Group A": 675, "Group B": 186, "Group C": 86, "Group D": 53},
        },
    )
