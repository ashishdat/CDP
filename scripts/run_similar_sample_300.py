#!/usr/bin/env python3
"""Run product-gate test on 300 holdout stratified docs from Hackathon Drive zip.
...
DOCS = ROOT / "docs/metrics/similar_sample_300_v1/selected_documents.txt"
OUT = ROOT / "evaluation_results/similar_sample_300_v1"
