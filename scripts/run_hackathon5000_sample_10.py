#!/usr/bin/env python3
"""Hackathon-5000 stratified 10 — FAST (latency) or PRODUCT (STP gate).

Nested sample from sample_1000 (seed 20260925): A6 / B2 / C1 / D1.
...
Usage:
  python3 -u scripts/run_hackathon5000_sample_10.py           # FAST latency
  python3 -u scripts/run_hackathon5000_sample_10.py --product # STP gate run
  python3 -u scripts/run_hackathon5000_sample_10.py --fresh
"""
...
DOCS = ROOT / "docs/metrics/hackathon5000_sample_10_v1/selected_documents.txt"
OUT = ROOT / "evaluation_results/hackathon5000_sample_10_v1"
...
def main() -> int:
    ...
    write_run_manifest(
        ...
        extra={
            "runner": "run_hackathon5000_sample_10",
            "docs": len(docs),
            "selection_seed": 20260925,
            "alloc": {"Group A": 6, "Group B": 2, "Group C": 1, "Group D": 1},
