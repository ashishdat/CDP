#!/usr/bin/env python3
"""Redecide Independent-100 HITL claims with accuracy-first LLM path."""
...
METRICS = ROOT / "docs/metrics/hackathon_100_independent_v13.json"
OUT = ROOT / "evaluation_results/hackathon_100_independent_v13_hitl_redecide"
...
def main() -> int:
    ...
    print(f"redecide n={len(ids)} out={OUT}", flush=True)
